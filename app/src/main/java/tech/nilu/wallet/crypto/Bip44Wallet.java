...
import static tech.nilu.wallet.crypto.Bip44Wallet.HDUtil.concat;
import static tech.nilu.wallet.crypto.Bip44Wallet.HDUtil.createMasterPrivateKey;
import static tech.nilu.wallet.crypto.Bip44Wallet.HDUtil.deriveChildKey;
import static tech.nilu.wallet.crypto.Bip44Wallet.HDUtil.formatPath;
import static tech.nilu.wallet.crypto.Bip44Wallet.HDUtil.parsePath;
import static tech.nilu.wallet.crypto.Bip44Wallet.HashUtil.createHmacSha512Digest;
import static tech.nilu.wallet.crypto.Bip44Wallet.HashUtil.hmacSha512;
import static tech.nilu.wallet.crypto.Bip44Wallet.HashUtil.sha256hash160;
import static tech.nilu.wallet.crypto.Bip44Wallet.MiscUtil.checkArgument;
import static tech.nilu.wallet.crypto.Bip44Wallet.MiscUtil.checkNotNull;
import static tech.nilu.wallet.crypto.Bip44Wallet.MiscUtil.checkState;
...
public class Bip44Wallet {
    ...
    public Bip44Wallet(Bip39Locale lang, String pass) {
        ...
        this.seed = new HDSeed(checkNotNull(mnemonicBytes), System.currentTimeMillis() / 1000);
    ...
    static class HDUtil {
        ...
        static RawKeyBytes deriveChildKeyBytesFromPrivate(HDKey parent, ChildNumber childNumber) throws HDWalletException {
            checkArgument(parent.getPriv() != null, "Parent key must have private key bytes for this method.");
            ...
            byte[] i = hmacSha512(createHmacSha512Digest(parent.getChainCode()), data.array());
    ...
    public static class ECKey {
        ...
        public byte[] getPubKeyHash() {
            if (pubKeyHash == null)
                pubKeyHash = sha256hash160(this.pub);
            return pubKeyHash;
        }
    ...
    public static class HDKeyChain {
        ...
        public HDKeyChain(HDSeed seed) {
            ...
            rootKey = createMasterPrivateKey(checkNotNull(seed.getSeed()));
